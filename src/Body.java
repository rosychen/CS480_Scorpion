 ...
 * @due_date: 10/18/2016
 * 
 * Body.java - a model for the body of the scorpion
 */
...
public class Body extends Circular implements Displayable {
  ...
  /**
   * The OpenGL handle to the display list which contains all the components which comprise this cylinder.
   */
	
  private int callListHandle;

  /**
   * Instantiates this object with the specified radius and OpenGL utility toolkit object for drawing the sphere.
   * 
